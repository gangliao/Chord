...
inline Timer::Timer() : beginning_(0), ending_(0), beginning_seconds_(0.0), ending_seconds_(0.0), running_(false) {}
...
inline Timer::Second Timer::start_seconds() const { return beginning_seconds_; }
...
inline bool Timer::is_running() const { return running_; }
